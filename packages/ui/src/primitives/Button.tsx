...
/**
 * Button look — mirror of the web app's `@/components/ui/Button`. Copied so @kiwiply/ui is
 * self-contained; primitives unify into the design system in W5.1. Classes resolve against
 * the shared tokens (styles/tokens.css).
 */
...
/** Class string for the button look — use on a `<button>`/`<a>` that should look like a button. */
